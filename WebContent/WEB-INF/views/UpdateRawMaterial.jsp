        ...
        <div class="col-md-7">
          <div class="detail-box">
            ...
            <div class="login-container">
              ...
              <form action="updateRaw" method="post" id="loginForm" onsubmit="showMessageAndRedirect()">
               <input type="text" name="rid" placeholder=" Enter Raw Material Id ">
		       <input type="text" name="rquantity" placeholder=" Enter quantiy ">
