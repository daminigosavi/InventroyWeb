  ...
  <section class="experience_section layout_padding-top layout_padding2-bottom">
    <div class="container">
      <div class="row">
        <div class="col-md-5">
          <div class="img-box">
            <img src="images/experience-img.png" alt="not supporting">
          </div>
        </div>
        <div class="col-md-7">
          <div class="detail-box">
            ...
            <form action="addProcessed" method="post" id="loginForm" onsubmit="showMessageAndRedirect()">
                <input type="text" name="pname" placeholder="Enter Processed Material name"><br>
            <input type="text" name="pquantity" placeholder="Enter Quantity"><br>
            <select id="runit" name="punit">
            	<option value="pcs"> Pieces </option>
            	<option value="kg"> Kilogram </option>
            	<option value="ltr"> Litre </option>
                 </select><br>
                 <input type="text" name="pcostPerUnit" placeholder="Enter Cost per unit "><br>
                 <div class="btn-box">
