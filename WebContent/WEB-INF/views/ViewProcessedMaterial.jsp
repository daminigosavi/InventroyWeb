...
<%@page import="com.damini.inventorydb.*"%>
        ...
        <div class="container">
            ...
            <div class="content">
                ...
                <div class="table-container">
                    <%
			List<ProcessedMaterial> issueProcessed= (List<ProcessedMaterial>)request.getAttribute("processedMaterials");
		%>
		<table>
			<tr>
			...
			<%
				for(ProcessedMaterial ip:issueProcessed)
				{%>
					<tr>
						
						<td><%= ip.getPid() %></td>
						<td><%= ip.getPname() %></td>
						<td><%= ip.getPcostPerUnit() %></td>
						<td><%= ip.getPunit() %></td>
