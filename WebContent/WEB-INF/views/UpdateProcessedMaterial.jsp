        ...
        <div class="col-md-7">
          <div class="detail-box">
            ...
            <div class="login-container">
              ...
              <form action="updateProcessed"  method="post" id="loginForm" onsubmit="showMessageAndRedirect()">
               <input type="text" name="pid" placeholder=" Enter Processed Material Id ">
		        <input type="text" name="pquantity" placeholder=" Enter quantiy ">
