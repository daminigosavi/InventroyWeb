...
<body class="sub_page">
  ...
  <section class="experience_section layout_padding-top layout_padding2-bottom">
	...
	%>
	<form action="issueRawMaterial" method="post" id="loginForm" onsubmit="showMessageAndRedirect()">
		<input type="text" name="rid" value="<%=rid %>"><br>
		<input type="text" name="rname" value="<%=rname %>"><br>
