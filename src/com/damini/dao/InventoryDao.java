...
public class InventoryDao {
	...
	{
		int i=(int) hibernateTemplate.save(rawMaterial);
		return i;
	}
	...
	{
		int i=(int) hibernateTemplate.save(processedMaterial);
		return i;
	}
	...
	{
		int i=(int) hibernateTemplate.save(issueRaw);
		return i;
	}
	...
	{
		int i=(int) hibernateTemplate.save(issueProcessed);
		return i;
	}
	...
	public Manager viewManagerBypass(String pass) {
		
		
			return (Manager) this.hibernateTemplate.get(Manager.class,pass);
